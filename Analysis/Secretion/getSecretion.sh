...
# Note: there is a problem with running phobius; therefore, I use this program in its online version.
...
do   
    ...
    echo $g': run TMHMM'
    /path/to/Programs/tmhmm/2.0c/bin/tmhmm -short ../../Data/$g/$g"_valid_prot.fa" > $g/$g"_TMHMM.txt"
